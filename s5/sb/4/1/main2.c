...
volatile int main()
{
  ...
  int8_t  int8_t_a,  int8_t_b;
  int16_t int16_t_a, int16_t_b;
  int32_t int32_t_a, int32_t_b;
  int64_t int64_t_a, int64_t_b;
  ...
  while (1)
  {
...

    {
      ...
      volatile int8_t tmp1 =  int8_t_a + int8_t_b;
      b = TCNT1; // wartość licznika po czekaniu
      printf("\tint8_t:  %" PRIu16 " cykli\r\n", b - a);

      a = TCNT1; // wartość licznika przed czekaniem
      volatile int16_t tmp2 = int16_t_a + int16_t_b;
      b = TCNT1; // wartość licznika po czekaniu
      printf("\tint16_t: %" PRIu16 " cykli\r\n", b - a);

      a = TCNT1; // wartość licznika przed czekaniem
      volatile int32_t tmp3 = int32_t_a + int32_t_b;
      b = TCNT1; // wartość licznika po czekaniu
      printf("\tint32_t: %" PRIu16 " cykli\r\n", b - a);

      a = TCNT1; // wartość licznika przed czekaniem
      volatile int64_t tmp4 = int64_t_a + int64_t_b;
      b = TCNT1; // wartość licznika po czekaniu
      printf("\tint64_t: %" PRIu16 " cykli\r\n", b - a);

      a = TCNT1; // wartość licznika przed czekaniem
      volatile float tmp6 = float_a + float_b;
      b = TCNT1; // wartość licznika po czekaniu
...

    {
      ...
      a = TCNT1; // wartość licznika przed czekaniem
      volatile float tmp5 = float_a *float_b;
      b = TCNT1; // wartość licznika po czekaniu
      printf("\tfloat:   %" PRIu16 " cykli\r\n", b - a);
...

    {
      ...
      a = TCNT1; // wartość licznika przed czekaniem
      volatile float tmp8 =float_a / float_b;
      b = TCNT1; // wartość licznika po czekaniu
      printf("\tfloat:   %" PRIu16 " cykli\r\n", b - a);
